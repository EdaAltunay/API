...
import pojos.POJO_JsonPlaceRequestBody;
...
public class C25_Put_PojoClass extends JsonPlaceHolderBaseURL {
    ...
    public void put01(){
        ...
        POJO_JsonPlaceRequestBody expBody = new POJO_JsonPlaceRequestBody("Ahmet","Merhaba",10,70);
        ...
        POJO_JsonPlaceRequestBody respPojo =response.as(POJO_JsonPlaceRequestBody.class); // donen response'u kendi olusturdugumuz kaliba dokuyoruz.
