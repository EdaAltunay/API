...
public class C04_Put_ResponseBilgileriAssertion {
    ...
    public void put01(){
        ...
        /*
         ...
         direk json objesini yazdirirsam :
         {"id":70,"title":"Ahmet","body":"Merhaba","userId":10}  formatta duz gelir.
         Ancak response cevap olarak: "response.prettyPrint()" seklinde yazdirirsam {   } icersinde body olarak gelir.
       */
